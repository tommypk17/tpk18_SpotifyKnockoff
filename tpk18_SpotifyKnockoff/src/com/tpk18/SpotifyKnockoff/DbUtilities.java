...
//    private String dbPassword = "spotifyUser123"; // password for the database server
    ...
    private void createDbConnection(){
        try {
            ...
            String mySqlConn = "jdbc:mysql://" + hostName + "/" + dbName + "?user=" + dbUserName + "&password=" + dbPassword+"&useSSL=false";
    ...
    /**
     * 
     * @return Connection - used to get the connection to the Database
     */
